 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(GameplayTagPinEditorNameTest, "LogicDriver.BugFixes.GameplayTagPinEditorName", EAutomationTestFlags::ApplicationContextMask |
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool GameplayTagPinEditorNameTest::RunTest(const FString& Parameters)
{
	FText TagEditorName;
	const bool bFoundLocalizedName = (FText::FindText(TEXT("GameplayTagContainerCombo"),
